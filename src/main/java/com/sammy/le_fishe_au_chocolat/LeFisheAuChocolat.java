...
public class LeFisheAuChocolat {
	...
	public static final RegistryObject<SoundEvent> CHOIR_OF_LE_FISHE = SOUNDS.register("coeur_du_fishe", () -> new SoundEvent(new ResourceLocation("le_fishe_au_chocolat:coeur_du_fishe")));

	public static final RegistryObject<Item> LE_FISHE_AU_CHOCOLAT = ITEMS.register("le_fishe_au_chocolat", () ->
			new LeFisheItem(new Item.Properties().tab(CreativeModeTab.TAB_FOOD).food(new FoodProperties.Builder().nutrition(8).saturationMod(0.3F).build())));
	public static final RegistryObject<Item> LE_FISHE_AU_CHOCOLAT_COOKED = ITEMS.register("le_fishe_au_chocolat_grille", () ->
			new LeFisheItem(new Item.Properties().tab(CreativeModeTab.TAB_FOOD).food(new FoodProperties.Builder().nutrition(10).saturationMod(0.4F).build())));
